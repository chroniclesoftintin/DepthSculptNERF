...
# blender info
bl_info = {
    'name': 'DepthSculptNERF',
    'description': 'Easy NeRF synthetic dataset creation within Blender',
    'author': 'Maxime Raafat',
    'version': (5, 0, 0),
    'blender': (3, 0, 0),
    'location': '3D View > N panel > DepthSculptNERF',
    'doc_url': 'https://github.com/maximeraafat/DepthSculptNERF',
    'category': 'Object',
}
...
PROPS = [
    ...
    ('logs', bpy.props.BoolProperty(name='Save Log File', description='Whether to create a log file containing information on the DepthSculptNERF run', default=False) ),
    ...
    ('DepthSculptNERF_version', bpy.props.StringProperty(name='DepthSculptNERF Version', default=VERSION) ),
...
CLASSES = [
    blender_nerf_ui.DepthSculptNERF_UI,
    sof_ui.SOF_UI,
    ttc_ui.TTC_UI,
    cos_ui.COS_UI,
